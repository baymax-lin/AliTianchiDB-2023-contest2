        ...
        case GREATER:
            ...
            switch (columnType) {
                ...
                case COLUMN_TYPE_INTEGER:
                    ...
                    if (ret1 != 0 || ret2 != 0) {
                        std::cerr << "Cannot get COLUMN_TYPE_INTEGER type "
                                     "value, doCompare failed"
                                  << std::endl;
                        throw std::exception();
                    }
                    return i1 > i2;
                case COLUMN_TYPE_DOUBLE_FLOAT:
                    ...
                    if (ret1 != 0 || ret2 != 0) {
                        std::cerr << "Cannot get COLUMN_TYPE_DOUBLE_FLOAT type "
                                     "value, doCompare failed"
                                  << std::endl;
                        throw std::exception();
                    }
                    return d1 > d2;
                default:
                    std::cerr << "Unsupported column type for comparing: "
                              << getNameFromColumnType(columnType) << std::endl;
                    throw std::exception();
            }
    }
    return false;
